...
{
	kTRANSFER_SRC_BIT = 0x00000001,
	kTRANSFER_DST_BIT = 0x00000002,
	kSAMPLED_BIT = 0x00000004,
	kSTORAGE_BIT = 0x00000008,
	kCOLOR_ATTACHMENT_BIT = 0x00000010,
	kDEPTH_STENCIL_ATTACHMENT_BIT = 0x00000020,
	kTRANSIENT_ATTACHMENT_BIT = 0x00000040,
	kINPUT_ATTACHMENT_BIT = 0x00000080,
	kFLAG_BITS_MAX_ENUM = 0x7FFFFFFF
};

enum ImageCreateFlagBits 
{
	kSPARSE_BINDING_BIT = 0x00000001,
	kSPARSE_RESIDENCY_BIT = 0x00000002,
	kSPARSE_ALIASED_BIT = 0x00000004,
	kMUTABLE_FORMAT_BIT = 0x00000008,
	kCUBE_COMPATIBLE_BIT = 0x00000010,
	kALIAS_BIT = 0x00000400,
	kSPLIT_INSTANCE_BIND_REGIONS_BIT = 0x00000040,
	k2D_ARRAY_COMPATIBLE_BIT = 0x00000020,
	kBLOCK_TEXEL_VIEW_COMPATIBLE_BIT = 0x00000080,
	kEXTENDED_USAGE_BIT = 0x00000100,
	kPROTECTED_BIT = 0x00000800,
	kDISJOINT_BIT = 0x00000200,
	kSAMPLE_LOCATIONS_COMPATIBLE_DEPTH_BIT_EXT = 0x00001000,
	kSPLIT_INSTANCE_BIND_REGIONS_BIT_KHR = kSPLIT_INSTANCE_BIND_REGIONS_BIT,
	k2D_ARRAY_COMPATIBLE_BIT_KHR = k2D_ARRAY_COMPATIBLE_BIT,
	kBLOCK_TEXEL_VIEW_COMPATIBLE_BIT_KHR = kBLOCK_TEXEL_VIEW_COMPATIBLE_BIT,
	kEXTENDED_USAGE_BIT_KHR = kEXTENDED_USAGE_BIT,
	kDISJOINT_BIT_KHR = kDISJOINT_BIT,
	kALIAS_BIT_KHR = kALIAS_BIT,
	kFLAG_BITS_MAX_ENUM = 0x7FFFFFFF
};
