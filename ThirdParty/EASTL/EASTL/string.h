...
///////////////////////////////////////////////////////////////////////////////
// (FIRESTORM) For conversion between std::string and eastl::string.
#include <string>
...
namespace eastl
{
	...
	public:
		...
		///////////////////////////////////////////////////////////////////////////////
		// (FIRESTORM)
		basic_string(const std::string& std_string);
	   ...
	   ~basic_string();
		...
		this_type& operator=(const std::string& std_str);
	...
	// (FIRESTORM) Conversion
	template <typename T, typename Allocator>
	inline basic_string<T, Allocator>::basic_string(const std::string& std_string)
	{
		assign(std_string.c_str());
	}
	...
	template <typename T, typename Allocator>
	inline typename basic_string<T, Allocator>::this_type& basic_string<T, Allocator>::operator=(const std::string& std_str)
	{
